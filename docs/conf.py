...
# -*- coding: utf-8 -*-
#
# pdsspect documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'pdsspect.tex', 'pdsspect Documentation',
     'PlanetaryPy', 'manual'),
]
...
man_pages = [
    (master_doc, 'pdsspect', 'pdsspect Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pdsspect', 'pdsspect Documentation',
     author, 'pdsspect', 'One line description of project.',
     'Miscellaneous'),
]
